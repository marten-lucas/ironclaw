...
use crate::descriptors::{
    ...
    WEBUI_V2_PATTERN_SETTINGS_AGENT_DETAIL, WEBUI_V2_PATTERN_SETTINGS_AGENT_REVERT,
    ...
    WEBUI_V2_PATTERN_SETTINGS_MODEL_PROFILE_REVERT, WEBUI_V2_PATTERN_SETTINGS_MODEL_PROFILES,
...
pub fn webui_v2_router_with_options(state: WebUiV2State, options: WebUiV2RouteOptions) -> Router {
    let mut router = Router::new()
        ...
        .route(
            ...
            post(handlers::revert_settings_model_profile),
        )
        .route(
        ...
        .route(
            ...
            post(handlers::revert_settings_agent),
        )
        .route(
            WEBUI_V2_PATTERN_SETTINGS_CHANNEL_CONFIG_REVERT,
            post(handlers::revert_settings_channel_config),
        )
        .route(
            WEBUI_V2_PATTERN_SETTINGS_SKILL_REVERT,
            post(handlers::revert_settings_skill),
        )
        .route(
