...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_LIST_SETTINGS_AGENTS, WEBUI_V2_ROUTE_LIST_SETTINGS_AUDIT,
    WEBUI_V2_ROUTE_GET_SETTINGS_AUDIT_DIFF,
    WEBUI_V2_ROUTE_LIST_SETTINGS_DELEGATIONS, WEBUI_V2_ROUTE_LIST_SETTINGS_IDENTITY,
    WEBUI_V2_ROUTE_LIST_SETTINGS_MEMORY, WEBUI_V2_ROUTE_LIST_SETTINGS_MODEL_PROFILES,
    WEBUI_V2_ROUTE_LIST_SETTINGS_TOOL_POLICIES, WEBUI_V2_ROUTE_LIST_SETTINGS_TOOLS,
    ...
    WEBUI_V2_ROUTE_PAUSE_AUTOMATION, WEBUI_V2_ROUTE_RENAME_AUTOMATION,
    ...
    WEBUI_V2_ROUTE_SEARCH_SKILLS, WEBUI_V2_ROUTE_SEND_EXTENSION_TEST_MESSAGE,
    WEBUI_V2_ROUTE_SEND_MESSAGE, WEBUI_V2_ROUTE_SET_ACTIVE_LLM,
    WEBUI_V2_ROUTE_SET_AUTO_ACTIVATE_LEARNED, WEBUI_V2_ROUTE_SET_SETTINGS_TOOL_PERMISSION,
    ...
    WEBUI_V2_ROUTE_STREAM_EVENTS_WS, WEBUI_V2_ROUTE_TEST_EXTENSION_CONNECTION,
    ...
    WEBUI_V2_ROUTE_UPSERT_SETTINGS_AGENT, WEBUI_V2_ROUTE_UPSERT_SETTINGS_AUDIT_ENTRY,
    WEBUI_V2_ROUTE_UPSERT_SETTINGS_DELEGATION, WEBUI_V2_ROUTE_UPSERT_SETTINGS_IDENTITY,
    WEBUI_V2_ROUTE_UPSERT_SETTINGS_MEMORY, WEBUI_V2_ROUTE_UPSERT_SETTINGS_MODEL_PROFILE,
    WEBUI_V2_ROUTE_UPSERT_SETTINGS_TOOL_POLICY, WEBUI_V2_ROUTE_UPSERT_LLM_PROVIDER,
...
#[cfg(feature = "webui-v2-beta")]
pub use governed_authoring::{
    AgentRosterEntry, AuditEntry, DelegationStatus, DelegationTask, GovernedAuthoringKind,
    IdentityDocument, IdentitySubjectType, MemoryItem, MemoryScope,
    SETTINGS_AGENT_CONFIG_PREFIX,
    SETTINGS_AUDIT_CONFIG_PREFIX, SETTINGS_DELEGATION_CONFIG_PREFIX,
    ...
    config_key as governed_authoring_config_key,
    parse_config_key as parse_governed_authoring_config_key,
};
#[cfg(feature = "webui-v2-beta")]
pub use handlers::{
    ...
    run_operator_setup, search_skills, send_extension_test_message, send_message, set_active_llm,
    set_operator_config_key, set_outbound_preferences, setup_extension, start_codex_login,
