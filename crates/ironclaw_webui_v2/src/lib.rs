...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_LIST_SETTINGS_DELEGATIONS, WEBUI_V2_ROUTE_LIST_SETTINGS_MODEL_PROFILES,
    ...
    WEBUI_V2_ROUTE_UPSERT_SETTINGS_AGENT, WEBUI_V2_ROUTE_UPSERT_SETTINGS_MODEL_PROFILE,
