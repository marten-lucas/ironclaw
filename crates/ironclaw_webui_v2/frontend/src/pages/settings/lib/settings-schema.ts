export const SETTINGS_TABS = [
  ...
  { id: "modelProfiles", labelKey: "settings.modelProfiles", icon: "layers" },
  { id: "identity", labelKey: "settings.identity", icon: "lock" },
  { id: "memory", labelKey: "settings.memory", icon: "file" },
  { id: "toolPolicies", labelKey: "settings.toolPolicies", icon: "tool" },
  { id: "agents", labelKey: "settings.agents", icon: "spark" },
  { id: "delegations", labelKey: "settings.delegations", icon: "send" },
  { id: "audit", labelKey: "settings.audit", icon: "logs" },
