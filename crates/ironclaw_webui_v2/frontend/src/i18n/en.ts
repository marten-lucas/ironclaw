...
registerPack("en", {
  ...
  "settings.toolPolicies": "Tool Policies",
  ...
  // Settings — Agents roster
  "agents.title": "Agent roster ({count})",
  "agents.createTitle": "Create agent",
  "agents.displayName": "Display name",
  "agents.createPlaceholder": "e.g. Security Reviewer",
  "agents.role": "Role",
  "agents.defaultProfile": "Default profile",
  "agents.create": "Create agent",
  "agents.empty": "No agents configured.",
  "agents.rename": "Rename",
  "agents.saveName": "Save name",
  ...
  "modelProfiles.title": "Model profile mapping",
  "modelProfiles.empty": "No model profiles available.",
  "modelProfiles.model": "Model",
  "modelProfiles.temperature": "Temperature",
  "modelProfiles.required": "required",
  "modelProfiles.optional": "optional",
  "modelProfiles.saveInline": "Saved",
  "modelProfiles.defaultMissing": "Invalid configuration: model_profiles.default must be set.",
  "modelProfiles.failedLoad": "Could not load model profiles: {message}",

  // Settings — Delegations
  "delegations.title": "Open delegations ({count})",
  "delegations.empty": "No open delegations.",
  "delegations.requestedProfile": "Requested profile",
  "delegations.resolvedProfile": "Resolved profile",
  "delegations.fallbackWarning": "Fallback applied: requested profile resolved to a different model profile.",
  "delegations.failedLoad": "Could not load delegations: {message}",

  // Settings — Audit
  "audit.title": "Recent changes ({count})",
  ...
  "workspace.area.home": "User",
  "workspace.area.memory": "Soul",
